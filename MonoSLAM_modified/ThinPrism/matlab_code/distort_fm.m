...
% Distort undistorted pixel coordinates using the thin prism model.
% Input:  uv  - 2xN undistorted pixel coordinates (output of hu.m)
% Output: uvd - 2xN distorted pixel coordinates

% 1. Normalize back to fisheye-projected space
u = (uv(1,:) - camera.Cx) ./ camera.fx;
v = (uv(2,:) - camera.Cy) ./ camera.fy;
